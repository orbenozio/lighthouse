...
{
    // Builds the Lighthouse Android APK from the open editor. BuildPlayer is synchronous and blocks the
    ...
    {
        [McpTool("build_android", "Build the Lighthouse Android APK to Builds/Lighthouse.apk from the open editor. Writes Builds/last_build.json (poll it; the call blocks for the whole build).")]
        public static object Invoke(
            string scene = "Assets/Game/Scenes/Game.unity",
            string output = "Builds/Lighthouse.apk",
            bool development = false)
        {
            ...
            try
            {
                ...
                PlayerSettings.SetApplicationIdentifier(BuildTargetGroup.Android, "com.crossroads.lighthouse");
                PlayerSettings.productName = "Lighthouse";
