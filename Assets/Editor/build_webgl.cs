...
{
    // Builds the Lighthouse WebGL player to a folder (index.html) for itch.io browser play. BuildPlayer is
    ...
    {
        [McpTool("build_webgl", "Build the Lighthouse WebGL player to a folder (default Builds/WebGL) for itch.io browser play. Gzip + decompression fallback so it runs on itch's plain hosting. Writes Builds/last_build.json.")]
